...
const CHECKS: &[Check] = &[
    Check {
        name: "mise",
        required: true,
        hint: "curl https://mise.run | sh",
    },
    Check {
        name: "cargo",
        required: true,
        hint: "rustup install stable",
    },
    Check {
        name: "cargo-tauri",
        required: true,
        hint: "cargo install tauri-cli",
    },
    Check {
        name: "bun",
        required: true,
        hint: "mise install bun",
    },
    Check {
        name: "xcodebuild",
        required: false,
        hint: "install Xcode from App Store (macOS only)",
    },
    Check {
        name: "adb",
        required: false,
        hint: "mise run setup (installs Android SDK)",
    },
    Check {
        name: "utmctl",
        required: false,
        hint: "brew install --cask utm (needed for Windows/Linux VMs)",
    },
    Check {
        name: "wasm-pack",
        required: false,
        hint: "mise install cargo:wasm-pack",
    },
];
...
pub fn run() -> anyhow::Result<()> {
    ...
    println!();
    println!("ok={ok} missing_required={missing_required} missing_optional={missing_optional}");
